...
if __name__ == "__main__":
    ...
    parser.add_argument('--gt', type=str, default='./datasets/imgur5k_gt/gt_150_words_per_image.txt')
    parser.add_argument('--stable_dif_path', type=str, default='stabilityai/stable-diffusion-2-1')
    parser.add_argument('--models_path', type=str, default='./trained_models/imgur5k_model')
    parser.add_argument('--writer_dict', type=str, default='./imgur5k_writers_dict_train.json')
